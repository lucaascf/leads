...
# ============================================
# PASSO 3 REESCRITO: BUSCAR DADOS DAS EMPRESAS
# ============================================

print("\n📂 [3/4] Buscando dados das empresas... (versão otimizada)")

# Conjunto de CNPJs a buscar
cnpjs_para_buscar = frozenset(cnpjs_necessarios)
dados_empresas = {}

# Função segura para mapear porte
def mapear_porte_seguro(porte_codigo):
    if pd.isna(porte_codigo):
        return "NÃO INFORMADO"
    porte_str = str(porte_codigo).strip().zfill(2)  # garante '01', '03', '05'
    return {
        "01": "MICRO EMPRESA",
